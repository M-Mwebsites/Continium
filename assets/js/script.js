    ...
    const navbarlinksActive = () => {
        ...
        navbarlinks.forEach(navbarlink => {
            ...
            if (position >= section.offsetTop && position <= (section.offsetTop + section.offsetHeight)) {
                ...
                if (navbarlink.className.includes("button-info")) {
    ...
    if (selectHeader) {
        const headerScrolled = () => {
            if (window.scrollY > 210) {
                ...
                document.getElementById('logo-title').classList.remove('show');
            }
            else {
                document.getElementById('logo-header').classList.add('hide');
                document.getElementById('logo-title').classList.add('show');
                document.getElementById('logo-header').classList.remove('show');
                document.getElementById('logo-title').classList.remove('hide');
            }
        }
